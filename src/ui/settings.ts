  ...
  content.innerHTML = `
    ...
    <section class="mb-5 [&_h3]:text-[13px] [&_h3]:font-semibold [&_h3]:text-fg-soft [&_h3]:uppercase [&_h3]:tracking-[0.5px] [&_h3]:mb-2">
      ...
      <div class="mt-2 flex gap-2">
        <button id="settings-alert-test" class="inline-flex items-center justify-center [padding:4px_10px] border border-line rounded-chip text-[11px] font-medium cursor-pointer [transition:all_0.15s] text-fg-soft bg-transparent max-[800px]:[padding:6px_12px] max-[800px]:text-[13px] pointer-coarse:min-h-11 hover:[filter:brightness(1.15)] active:[transform:scale(0.97)] [.file-popover-actions_&]:text-[12px] [.file-popover-actions_&]:[padding:4px_10px] max-[800px]:[.file-actions_&]:min-h-9 max-[800px]:[.file-actions_&]:min-w-9 max-[800px]:[.file-actions_&]:[padding:6px_8px]">Test sound</button>
      </div>
    ...
    <section class="mb-5 [&_h3]:text-[13px] [&_h3]:font-semibold [&_h3]:text-fg-soft [&_h3]:uppercase [&_h3]:tracking-[0.5px] [&_h3]:mb-2">
      ...
      <div class="mt-2 flex gap-2">
        <button id="settings-reset-layout" class="inline-flex items-center justify-center [padding:4px_10px] border border-line rounded-chip text-[11px] font-medium cursor-pointer [transition:all_0.15s] text-fg-soft bg-transparent max-[800px]:[padding:6px_12px] max-[800px]:text-[13px] pointer-coarse:min-h-11 hover:[filter:brightness(1.15)] active:[transform:scale(0.97)] [.file-popover-actions_&]:text-[12px] [.file-popover-actions_&]:[padding:4px_10px] max-[800px]:[.file-actions_&]:min-h-9 max-[800px]:[.file-actions_&]:min-w-9 max-[800px]:[.file-actions_&]:[padding:6px_8px]">Reset to default</button>
      </div>
    </section>
  ...
  try {
    ...
    container.innerHTML = `
      ...
      <div class="mb-2 [&_label]:block [&_label]:text-[0.8rem] [&_label]:text-fg-muted [&_label]:mb-1">
        <label>Chat ID</label>
        <input type="text" class="bg-input border border-line rounded-chip text-[var(--text)] [padding:6px_10px] text-[0.85rem] w-full disabled:opacity-[0.5] [.settings-input-row_&]:w-20" value="${data.chatId}" disabled>
      </div>
      <div class="mb-2 [&_label]:block [&_label]:text-[0.8rem] [&_label]:text-fg-muted [&_label]:mb-1">
        <label>Progress interval</label>
        <div class="settings-input-row flex items-center gap-2">
          <input type="number" id="settings-tg-progress" class="bg-input border border-line rounded-chip text-[var(--text)] [padding:6px_10px] text-[0.85rem] w-full disabled:opacity-[0.5] [.settings-input-row_&]:w-20" value="${data.progressInterval}" min="5" max="50" step="5">
          ...
          <button id="settings-tg-save" class="inline-flex items-center justify-center [padding:4px_10px] border-0 rounded-chip text-[11px] font-medium cursor-pointer [transition:all_0.15s] text-white bg-accent max-[800px]:[padding:6px_12px] max-[800px]:text-[13px] pointer-coarse:min-h-11 hover:[filter:brightness(1.15)] active:[transform:scale(0.97)] [.file-popover-actions_&]:text-[12px] [.file-popover-actions_&]:[padding:4px_10px] max-[800px]:[.file-actions_&]:min-h-9 max-[800px]:[.file-actions_&]:min-w-9 max-[800px]:[.file-actions_&]:[padding:6px_8px] [.print-dialog-footer_&]:min-w-25">Save</button>
        </div>
      </div>
    `;

  ...
  el.innerHTML = `
    <div class="bg-card border border-line rounded-card [box-shadow:0_8px_32px_rgba(0,_0,_0,_0.5)] w-95 max-w-[90vw]">
      <div class="flex justify-between items-center [padding:12px_16px] border-b border-line [&_h3]:m-0 [&_h3]:text-[14px] [&_h3]:text-fg [&_h3]:normal-case [&_h3]:tracking-[0]">
        ...
        <button class="inline-flex items-center justify-center [padding:4px_10px] border border-line rounded-chip text-[11px] font-medium cursor-pointer [transition:all_0.15s] text-fg-soft bg-transparent max-[800px]:[padding:6px_12px] max-[800px]:text-[13px] pointer-coarse:min-h-11 hover:[filter:brightness(1.15)] active:[transform:scale(0.97)] [.file-popover-actions_&]:text-[12px] [.file-popover-actions_&]:[padding:4px_10px] max-[800px]:[.file-actions_&]:min-h-9 max-[800px]:[.file-actions_&]:min-w-9 max-[800px]:[.file-actions_&]:[padding:6px_8px]" id="fm-close" aria-label="Close">${iconSolo('close')}</button>
      </div>
      ...
      <div class="flex justify-end gap-2 [padding:12px_16px] border-t border-line">
        <button class="inline-flex items-center justify-center [padding:8px_16px] border border-line rounded-chip text-[13px] font-medium cursor-pointer [transition:all_0.15s] text-fg-soft bg-transparent max-[800px]:[padding:8px_16px] pointer-coarse:min-h-11 hover:[filter:brightness(1.15)] active:[transform:scale(0.97)] [.file-popover-actions_&]:text-[12px] [.file-popover-actions_&]:[padding:4px_10px] max-[800px]:[.file-actions_&]:min-h-9 max-[800px]:[.file-actions_&]:min-w-9 max-[800px]:[.file-actions_&]:[padding:6px_8px]" id="fm-cancel">Cancel</button>
        <button class="inline-flex items-center justify-center [padding:8px_16px] border-0 rounded-chip text-[13px] font-medium cursor-pointer [transition:all_0.15s] text-white bg-accent max-[800px]:[padding:8px_16px] pointer-coarse:min-h-11 hover:[filter:brightness(1.15)] active:[transform:scale(0.97)] [.file-popover-actions_&]:text-[12px] [.file-popover-actions_&]:[padding:4px_10px] max-[800px]:[.file-actions_&]:min-h-9 max-[800px]:[.file-actions_&]:min-w-9 max-[800px]:[.file-actions_&]:[padding:6px_8px] [.print-dialog-footer_&]:min-w-25" id="fm-save">Save</button>
      </div>
    </div>
  `;
